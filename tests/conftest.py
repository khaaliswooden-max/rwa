...
def sample_pump_schedule_input() -> dict:
    ...
    return {
        ...
        "pump_power_kw": 22.0,
        "demand_forecast_m3h": [
            10, 8, 6, 5, 5, 8, 15, 25, 30, 28,
            26, 28, 30, 28, 26, 28, 32, 35, 30, 25,
            20, 15, 12, 10
        ],
        "electricity_rates": [
            0.08, 0.08, 0.08, 0.08, 0.08, 0.08,  # Off-peak
            0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12,  # Mid-peak
            0.18, 0.18, 0.18, 0.18, 0.18, 0.18, 0.18, 0.18,  # On-peak
            0.08, 0.08  # Off-peak
        ],
